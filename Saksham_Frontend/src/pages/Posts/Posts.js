                ...
                <div className='justify-center w-11/12 h-full bg-white my-14 mx-14 py-10'>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div class="mb-2 mt-6">
                            ...
                            <input type="text" class="p-2 rounded-lg block w-11/12 ml-10 border-2 border-gray-500" placeholder="Title" ref={jobtitle} />
                        </div>
                        ...
                        <div id="exper/location" class="grid grid-cols-6 gap-8 mb-2 mt-4">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" class="p-2 rounded-lg block w-10/12 ml-10 border-2 border-gray-500" placeholder="Job Location" ref={location} />
                            </div>
                        </div>
                        ...
                        <div id="salary/disability" class="grid grid-cols-6 gap-8 mb-2 mt-4">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" class="p-2 rounded-lg block w-11/12 ml-10 border-2 border-gray-500" placeholder="Job Salary" ref={salary} />
                            </div>
                        ...
                        <div class="mb-2 mt-6">
                            ...
                            <input type="text" class="p-2 rounded-lg block w-11/12 ml-10 border-2 border-gray-500" placeholder="Submission url" ref={submission} />
                        </div>
                        ...
                        <div class="grid grid-cols-6 gap-8 mb-2 mt-4">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" class="p-2 rounded-lg block w-11/12 ml-10 border-2 border-gray-500" placeholder="Company Name" ref={company_name} />
                            </div>

                            <div class="col-span-6 sm:col-span-3">
                                <label class="my-2 text-xl block ml-10">Website URL</label>
                                <input type="text" class="p-2 rounded-lg block w-10/12 ml-10 border-2 border-gray-500" placeholder="Website Url" ref={website} />
                            </div>
                        </div>
                        ...
                        <div id="exper/location" class="grid grid-cols-6 gap-8 mb-2 mt-4">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" class="p-2 rounded-lg block w-10/12 ml-10 border-2 border-gray-500" placeholder="Company Email" ref={email} />
                            </div>
                        </div>
                        ...
                        <div id="salary/disability" class="grid grid-cols-6 gap-8 mb-2 mt-4">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <textarea type="text" class="p-2 rounded-lg block w-11/12 ml-10 pb-20 border-2 border-gray-500" placeholder="Company Bio" ref={bio} />
                            </div>
                        </div>
                        ...
                        <div id="salary/disability" class="grid grid-cols-6 gap-8 mb-2 mt-4">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" class="p-2 rounded-lg block w-11/12 ml-10 border-2 border-gray-500" placeholder="Company Logo" ref={logo} />
                            </div>
                        </div>
                        <hr className='mt-20 border-4' />
                        <div className='ml-14'>
                        ...
                        <div class="mb-2 mt-6">
                            ...
                            <textarea type="text" class="p-2 rounded-lg block w-11/12 ml-10 pb-20 border-2 border-gray-500" placeholder="Responsibilities" ref={responsible} />
                        </div>
                        <div class="mb-2 mt-6">
                            <label class="mb-2 text-xl block ml-10">Required Skills and Experience</label>
                            <textarea type="text" class="p-2 rounded-lg block w-11/12 ml-10 pb-20 border-2 border-gray-500" placeholder="Skills" ref={requiredskills} />
                        </div>
                        <div class="mb-2 mt-6">
                            <label class="mb-2 text-xl block ml-10">About Job Role</label>
                            <textarea type="text" class="p-2 rounded-lg block w-11/12 ml-10 pb-20 border-2 border-gray-500" placeholder="Job Role" ref={jobroles} />
                        </div>
                        <div class="mb-2 mt-6">
                            <label class="mb-2 text-xl block ml-10">Ideal Candidate</label>
                            <textarea type="text" class="p-2 rounded-lg block w-11/12 ml-10 pb-20 border-2 border-gray-500" placeholder="Ideal Candidate" ref={ideal} />
                        </div>
                        <div class="mb-2 mt-6">
                            <label class="mb-2 text-xl block ml-10">Perks and Benefits</label>
                            <textarea type="text" class="p-2 rounded-lg block w-11/12 ml-10 pb-20 border-2 border-gray-500" placeholder="Perks" ref={benefits} />
                        </div>
                        <div class="mb-2 mt-6">
                            <label class="mb-2 text-xl block ml-10">Hiring Process/Stages</label>
                            <textarea type="text" class="p-2 rounded-lg block w-11/12 ml-10 pb-20 border-2 border-gray-500" placeholder="Process" ref={stages} />
                        </div>
                        <div>
